...
* <Link to='/inductive/' aria-label='Bottom-up FP'>Learn FP from examples &rarr; concepts</Link> (bottom-up)
* <Link to='/deductive/' aria-label='Top-down FP'>Learn FP from concepts &rarr; examples</Link> (top-down)
* <Link to='/patterns-antipatterns/' aria-label='Patterns and antipatterns'>Patterns and antipatterns</Link>
