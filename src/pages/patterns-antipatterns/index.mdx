...
<ul>
  <li>
    <Link to='/patterns-antipatterns/#no-more-page-objects' aria-label='No more Page Objects'>No more Page Objects</Link>
  </li>
  <li>
    <Link to='/patterns-antipatterns/#enter-page-modules' aria-label='Enter Page Modules'>Enter Page Modules</Link>
  </li>
  <li>
    <Link to='/patterns-antipatterns/#but-what-about-inheritance' aria-label='But what about inheritance?'>But what about inheritance?</Link>
  </li>
  <li>
    <Link to='/patterns-antipatterns/#favour-composition-over-inheritance' aria-label='Favour composition over inheritance'>Favour composition over inheritance</Link>
  </li>
</ul>
