...
We know what you're thinking! Whoa, that's insane, right? We can not only mutate the value of a variable but also the **type**? No way!
...
<CodeBlock {...letSource} theme='dark' />
...
You might remember, _but your code doesn't_, because you _overwrote it_. Now why you wanna destroy that state? What did it ever do to you?
