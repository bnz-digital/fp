...
**This is where the Underscore and Lodash libraries went wrong** (fixed in Lodash/FP), and what Ramda and Sanctuary got so right.
...
1. Do not destroy state: make a new copy
1. Do not share state between processes: keep processes isolated
