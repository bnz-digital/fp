...
There are also several libraries for creating immutable objects&mdash;[Immutable.js](https://github.com/immutable-js/immutable-js)&mdash;or for simply freezing objects recursively&mdash:[deep-freeze](https://www.npmjs.com/package/deep-freeze).
