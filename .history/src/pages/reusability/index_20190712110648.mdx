...
Let's try another approach using functions _without loops_. We'll see more of this in the next section, <Link to="/iteration/" aria-label="Iteration">Loops are so last millennium!</Link>
